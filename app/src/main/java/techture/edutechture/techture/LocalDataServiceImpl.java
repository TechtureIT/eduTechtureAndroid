...
public class LocalDataServiceImpl  {
    ...
    public static LocalDataServiceImpl getInstance(TechtureApplication application) {
        if (mInstance == null) {
    ...
    public Admin getAdminResponse(){
        return first(Admin.class);
    }

    public void addOAuthToken(Admin admin){
        try {
    ...
    public Admin getAdmin(){
        Admin admin = Admin.first(Admin.class);
        return admin;
    }
...
//        OAuthDetailsRequestResponse auth =  OAuthDetailsRequestResponse.first(OAuthDetailsRequestResponse.class);
//
//
//        return auth;
//    }
