...
public class Util {
    ...
    public static boolean checkNetworkStatus(Context context) {
        try {
            TechtureConstants.isNetworkOnline = false;

            ConnectivityManager cm = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo netInfo = cm.getNetworkInfo(0);
            if (netInfo != null && netInfo.getState() == NetworkInfo.State.CONNECTED) {
                TechtureConstants.isNetworkOnline = true;
            } else {
        ...
        return TechtureConstants.isNetworkOnline;
    }
    ...
    public static void setFocusToEditText(TechtureActivity mActivity, View editName) {
        editName.setFocusableInTouchMode(true);
        editName.requestFocus();
        showKeyboard(mActivity, editName);
    }

    public static void showKeyboard(TechtureActivity mActivity, View editName) {
