...
public class GsonRequest extends JsonRequest<VolleyResponseBean> {
    ...
    private TechtureApplication mApp;
     ...
     */
    public GsonRequest(TechtureApplication mApp, Request.Priority priority, WebServiceType webServiceType, Class<?> classUser, String url, String requestBody,
