...
public class TechtureActivity  extends AppCompatActivity{
    protected static final String TAG = TechtureActivity.class.getSimpleName();
    protected TechtureApplication mApp;
...
//        Thread.setDefaultUncaughtExceptionHandler(new MyExceptionHandler(this));
    ...
    private void initMembers() {
        mApp = (TechtureApplication) getApplication();
